...
import christmasRaces.common.*;
import christmasRaces.core.interfaces.Controller;
import christmasRaces.entities.cars.*;
import christmasRaces.entities.drivers.*;
import christmasRaces.entities.races.*;
...
public class ControllerImpl implements Controller {
    ...
    public String startRace(String raceName) {
        ...
        if (race.getDrivers().size() < 3) {
            throw new IllegalArgumentException(String.format(ExceptionMessages.RACE_INVALID, raceName, RaceImpl.MINIMUM_PARTICIPANTS));
        }
        ...
        return String.format(OutputMessages.DRIVER_FIRST_POSITION, firstDriver.getName(), raceName) +
                System.lineSeparator() +
                String.format(OutputMessages.DRIVER_SECOND_POSITION, secondDriver.getName(), raceName) +
                System.lineSeparator() +
                String.format(OutputMessages.DRIVER_THIRD_POSITION, thirdDriver.getName(), raceName);
    }
