...
public class Spaceship {
    ...
    private int capacity; //места в космическия кораб
    private String name; //име на космическия кораб
    private final Collection<Astronaut> astronauts; //колекция от астронавти
