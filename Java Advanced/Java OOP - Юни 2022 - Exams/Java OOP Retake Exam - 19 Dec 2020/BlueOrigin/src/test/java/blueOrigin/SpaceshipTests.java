...
public class SpaceshipTests {
    ...
    private static final String SPACESHIP_NAME = "Кораб с дюзи от 1.9";
    private static final String FIRST_ASTRONAUT_NAME = "Джони";
    private static final double FIRST_ASTRONAUT_OXYGEN = 5.5;
    private static final String SECOND_ASTRONAUT_NAME = "Гошо";
    private static final double SECOND_ASTRONAUT_OXYGEN = 9.5;
    private static final String THIRD_ASTRONAUT_NAME = "Веси";
