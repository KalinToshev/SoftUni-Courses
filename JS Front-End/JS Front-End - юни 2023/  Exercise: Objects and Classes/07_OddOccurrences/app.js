function extractElementsFromSentence(input) {
...
extractElementsFromSentence("'Java C# Php PHP Java PhP 3 C# 3 1 5 C#'");
extractElementsFromSentence("'Cake IS SWEET is Soft CAKE sweet Food'");
